...
<head>
  ...
  <title>Staff Portal | Smile 360</title>
  ...
  <nav class="main-header navbar navbar-expand navbar-dark navbar-light elevation-4">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
          ...
          <li class="nav-item">
            <a href="https://smile360ng.com:2096" target="_blank" class="nav-link">              
              <p>
                Logon to Email
              </p>
            </a>
          ...
          <li class="nav-item">
            <a href="https://docs.google.com/forms/d/e/1FAIpQLSdZ8Kq-kEB061Ee0Rd3Sv9SEh90pHHJE3aUwvEQ3ViFe3FWkg/viewform?usp=sf_link" target="_blank" class="nav-link">              
              <p>
                Apply For Leave
              </p>
            </a>
