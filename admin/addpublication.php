...
<?php  
$conn=new PDO('mysql:host=localhost; dbname=intranet', 'root', '') or die(mysql_error());
$message = ""; 
$message2 = ""; 
...
if(isset($_POST['publish'])){
       ...
       if($move){
         $query=$conn->query("insert into publications(`headline`, `News`, `filename`)values('$headline','$news','$fname')");
        if($query){
