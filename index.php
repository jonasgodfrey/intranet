...
$from = 'hrsupport@smile360ng.com'; // this is the sender's Email address
$subject = "Smile 360 Staff Portal Credentials";


$emailing = ( '<p>Dear:</p>'.$fname . "\n\n " . 
" Username: " .$email . "\n\n".
" Password: " .$pass ."\n\n");
...
if($query_run = mysqli_query($conn, $query)){
  ...
  $headers = "From:" . $from;
  mail($to,$subject,$emailing,$headers);

  $message1 =  "<div class=\"alert alert-success\">
    <a href=\"register.php\" class=\"close\" data-dismiss=\"alert\" aria-label=\"close\">&times;</a>
     Account Created Successfully. Kindly Sign in with the email address and password you signed up with</div>";
...
<head>
  ...
  <title>Smile360  Staff Portal</title>
              ...
              <div class="bg-white-2 h-100 px-11 pt-11 pb-7">
                ...
                <form action="index.php" method="post">
                  <div class="form-group">
                    ...
                    <input type="text" name="fname" class="form-control" placeholder="Your Name" id="email2">
                  </div>
                  <div class="form-group">
                    <label for="email2" class="font-size-4 text-black-2 font-weight-semibold line-height-reset">E-mail</label>
                    <input type="email" name="email" class="form-control" value="myname@smile360ng.com" id="email2">
                  </div>
                  <div class="form-group">
                    <label for="email2" class="font-size-4 text-black-2 font-weight-semibold line-height-reset">Birthdate</label>
                    <input type="text" name="dob" class="form-control" placeholder="13th-Dec" id="email2">
                  </div>
                  <div class="form-group">
        ...
        <div class="row position-relative align-items-center">
          ...
          <div class="col-lg-6 col-md-4 col-sm-6 col-xs-6 col-8 pos-abs-br z-index-n1 position-static position-md-absolute mx-auto ml-md-auto" data-aos="fade-left" data-aos-duration="800" data-aos-once="true">
            <div class=" ml-xxl-23 ml-xl-12 ml-md-7">
              <img src="image/hero.png" alt="" class="w-100">
            </div>
          </div>
          <!-- ./Hero Right Image -->
        </div>
